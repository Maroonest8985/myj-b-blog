                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="post-preview">
                            <a href="detail.do?id=${blog.id}">
                             ...
                             <h3 class="post-subtitle">${blog.message}</h3>
                            </a>
                            <p class="post-meta">Posted by<a href="#!">${blog.email}</a>
                            </p>
                        </div>
                        <hr class="my-4" />
                        </c:forEach>
                        <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="#">Older</a></div>
                    </div>
                </div>
            </div>
        </article>
